        ...
        <form name="vendor_list_sort" method="post">
            ...
            <div class="mvx-store-map-filter">
                <div class="mvx-inp-wrap mvx-email">
                    <input type="text" name="locationText" id="locationText" placeholder="<?php esc_attr_e('Enter Address', 'besa'); ?>" value="<?php echo isset($request['locationText']) ? esc_attr($request['locationText']) : ''; ?>">
                </div>
                ...
                <input type="submit" name="vendorListFilter" value="<?php esc_attr_e('Submit', 'besa'); ?>">
            </div>
        </form>
        <?php endif; ?>
