        ...
        public function generateSubMegaMenu( $item, $tbay_mega_profile ) {
            ...
            if ( $tbay_mega_profile ) {
                ...
                if ( $posts && isset($posts[0]) ) {
                    ...
                    if( defined('TBAY_ELEMENTOR_ACTIVED') && besa_elementor_is_activated() && in_array( 'tbay_megamenu', get_option( 'elementor_cpt_support' ) ) ) {
                        $content = Elementor\Plugin::instance()->frontend->get_builder_content_for_display( $post->ID, besa_get_elementor_css_print_method() );
                    } else {
                    ...
                    if( besa_tbay_get_config('ajax_dropdown_megamenu', false) ) {  
