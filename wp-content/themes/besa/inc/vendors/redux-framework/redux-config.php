...
if (!class_exists('Besa_Redux_Framework_Config')) {
    ...
    class Besa_Redux_Framework_Config
    {
        ...
        public function setSections()
        {
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'title'     => esc_html__('Activated Skin', 'besa'),
                        'subtitle'  => '<em>'.esc_html__('Choose a skin for your website.', 'besa').'</em>',
                        'options'   => besa_tbay_get_themes(),
                        'default'   => 'style1'
                    ),
                    array(
                        'id'        => 'preload',
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => esc_html__('Enable "Ajax Dropdown" Mega Menu', 'besa'),
                        'default' => false,
                    ),
                    array(
                        'id' => 'dark_mode',
                        'type' => 'switch',
                        'required' => array(array('active_theme','=', 'style2')) ,
                        'title' => esc_html__('Enable Dark Mode', 'besa'),
                        'default' => false,
                    ),
                )
            );
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'default' => esc_html__('<p>Copyright  &#64; 2023 Besa Designed by ThemBay. All Rights Reserved.</p>', 'besa'),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type'      => 'switch',
                        'required'  => array(array('mobile_header','=', true),array('active_theme','=', 'style1')),
                    ...
                    array( 
                        'id'        => 'menu_mobile_all_page_2',
                        'type'      => 'switch',
                        'required'  => array(array('mobile_header','=', true),array('active_theme','=', 'style2')),
                        'title'     => esc_html__('Always Display Menu', 'besa'),
                        'subtitle'  => esc_html__('Menu displays on all pages (Icon Home is disabled)', 'besa'),
                        'default'   => false
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(                
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'required' => array(array('mobile_footer','=', true),array('active_theme','=', 'style2')) ,
                        'title' => esc_html__('Collapse widgets on mobile', 'besa'),
                        'subtitle'  => esc_html__('Widgets added to the footer will be collapsed by default and opened when you click on their titles.', 'besa'),
                        'default' => false
                    ),
                    ...
                    array(
                        ...
                        'required' => array('mobile_footer_menu_recent','=', true),
                        'desc'       => sprintf( 
                            wp_kses( __( 'Enter icon name of fonts: <a href="%s" target="_blank">Awesome</a> and <a href="%s" target="_blank">Materialdesigniconic</a> and <a href="%s" target="_blank">Simplelineicons</a> .  <a href="%s" target="_blank">How to use?</a> ', 'besa' ), 
                                array(  
                                    'a' => array( 'href' => array() ), 
                                )), '//fontawesome.com/v5.15/icons?d=gallery&p=2&m=free', 
                                    '//zavoloklom.github.io/material-design-iconic-font/icons.html',
                                    '//fonts.thembay.com/simple-line-icons',
                                    '//docs.urnawp.com/#use-menu-icon'
                                 ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array( 
                    ...
                    array(
                        ...
                        'default'  => esc_html__( 'Search in 20,000+ products...', 'besa' ),
                    ),   
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(                
                    ...
                    array(
                        ...
                        'type' => 'select',   
                        'title' => esc_html__('Add To Cart Form Type', 'besa'),
                        'subtitle' => esc_html__('On Page Single Product', 'besa'),
                        'options' => array(
                            'default' => esc_html__('Default', 'besa'),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'default'  => array(
                            'background-color' => $default_color['boby_bg'],
                        ),
                    ),
                    array (
            ...
            $this->sections[] = array(
                'subsection' => true,
                'title' => esc_html__('Search Products', 'besa'),
                'fields' => array(
                    array(
                        'id' => 'search_query_in',
                        'type' => 'button_set',
                        'title' => esc_html__('Search Query', 'besa'),
                        'options' => array(
                            'title' => esc_html__('Only Title', 'besa'), 
                            'all' => esc_html__('All (Title, Content, Sku)', 'besa'), 
                        ),
                        'default' => 'title'
                    ),
                    array(
                        'id' => 'search_sku_ajax',
                        'type' => 'switch',
                        'title' => esc_html__('Show SKU on AJAX results', 'besa'),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => esc_html__('Enable Quantity on Mini-Cart', 'besa'),
                        'default' => true
                    ),
                )
            ); 
            ...
            $this->sections[] = $this->woocommerce_shop_sections( $sidebars, $columns );
            ...
            $this->sections[] = array(
                ...
                'fields' => array(                   
                    array(
                        ...
                        'type' => 'switch',
                        'title' => esc_html__('Enable Views Count', 'besa'),
                        'default' => false
                    ),                     
                    array(
                        'id' => 'enable_buy_now',
                   ...
                   array(
                    ...
                    array(
                        'id' => 'after_meta_single_products_sidebar',
                        'type' => 'select',
                        'title' => esc_html__('After Meta Single Products Sidebar', 'besa'),
                        'options' => $sidebars,
                        'default' => 'after-meta-single-product',
                    ),
                )
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'type' => 'switch',
                        'title' => esc_html__('Show Confirm Password', 'besa'),
                        'default' => true
                    ),   
                    array(
            ...
            $this->sections[] = array(
                'subsection' => true,
                'title' => esc_html__('Checkout', 'besa'),
                'fields' => array(
                    array(
                        'id' => 'show_checkout_image',
                        'type' => 'switch',
                        'title' => esc_html__('Show Image', 'besa'),
                        'subtitle'  => esc_html__( 'Show image on page Checkout and Order Item Details', 'besa' ),
                        'default' => true
                    ),  
                )
            );
            ...
            $this->sections[] = array(
                'icon' => 'zmdi zmdi-grid',
                'title' => esc_html__('TB Add-Ons Elementor', 'besa'),
            );  

            $this->sections[] = array(
                'subsection' => true,
                'title' => esc_html__('General Add-Ons', 'besa'),
                'desc'       => esc_html__( 'Use the Toggle To Activate or Deactivate the TB Add-Ons elements below.', 'besa' ),
                'class' => 'tab-addons',
                'fields' => besa_redux_elementor_to_list_addons( besa_elementor_general_widgets() ),
            );

            $this->sections[] = array(
                'subsection' => true,
                'title' => esc_html__('Header Add-Ons', 'besa'),
                'desc'       => esc_html__( 'Use the Toggle To Activate or Deactivate the TB Add-Ons elements below.', 'besa' ),
                'class' => 'tab-addons',
                'fields' => besa_redux_elementor_to_list_addons( besa_elementor_header_widgets() ),
            );

            $this->sections[] = array(
                'subsection' => true,
                'title' => esc_html__('WooCommerce Add-Ons', 'besa'),
                'desc'       => esc_html__( 'Use the Toggle To Activate or Deactivate the TB Add-Ons elements below.', 'besa' ),
                'class' => 'tab-addons',
                'fields' => besa_redux_elementor_to_list_addons( besa_elementor_woocommerce_widgets() ),
            );
        ...
        public function multi_vendor_fields( $columns ) {
            ...
            if( class_exists('MVX') ) {
                $mvx_array = [
                    ...
                    'type' => 'info',
                    'title' => esc_html__('Enable Vendor Name Only MVX Vendor', 'besa'),
                    'subtitle' => sprintf(__('Go to the <a href="%s" target="_blank">Setting</a> Enable "Display Product Seller" for MVX Vendor', 'besa'), admin_url('admin.php?page=mvx#&submenu=settings&name=settings-general')),
                ];
            }
            ...
            $fields = array(
                array(
                    ...
                    'subtitle' => esc_html__('Enable/Disable Vendor Name on HomePage and Shop page only works for Dokan, mvx Vendor', 'besa'),
                    'default' => true
                ),  
                $mvx_array
            );
            ...
            if( class_exists('WeDevs_Dokan') ) {
                $fields_dokan = array(
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => esc_html__('Enable Tab Info Vendor Dokan', 'besa'),
                        'subtitle' => esc_html__('Enable/Disable tab Info Vendor on Product Detail Dokan', 'besa'),
                        'default' => true
                    ), 
                    array(
                        'id'        => 'show_seller_tab',
                        ...
                        'subtitle'  => sprintf(__('Go to the <a href="%s" target="_blank">Setting</a> of each Seller to Enable/Disable this tab of Dokan Vendor.', 'besa'), home_url('dashboard/settings/store/')),
                    ),
                    array(
        ...
        public function multi_vendor_sections( $columns ) {
            if( !besa_woo_is_active_vendor() ) return;
        ...
        public function woocommerce_shop_sections( $sidebars, $columns ) {
            $sections =  array(
                'subsection' => true,
                'title' => esc_html__('Shop', 'besa'),
                'fields' => $this->woocommerce_shop_sections_fields( $sidebars, $columns )
            );

            return $sections;
        }

        public function woocommerce_shop_sections_fields( $sidebars, $columns ) {
            $fields_start = $fields_end = array();
            ...
            $fields = array_merge( $fields_start, $fields_display_mode, $fields_end );
