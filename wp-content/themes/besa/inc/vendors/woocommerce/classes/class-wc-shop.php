...
if ( ! class_exists( 'Besa_Shop_WooCommerce' ) ) :
	...
	class Besa_Shop_WooCommerce  {
		...
		public function __construct() {
			...
			add_filter( 'besa_get_woocommerce_sub_categories', array( $this, 'show_product_subcategories'), 10, 1 );
		...
		public function shop_display_modes() {
	        ...
	        <div class="display-mode-warpper">
	            ...
	            <a href="javascript:void(0);" id="display-mode-grid" class="display-mode-btn <?php echo esc_attr($grid); ?>" title="<?php esc_attr_e('Grid','besa'); ?>" ><i class="<?php echo besa_get_icon('icon_shop_grid') ?>"></i></a>
	            <a href="javascript:void(0);" id="display-mode-list" class="display-mode-btn list <?php echo esc_attr($list); ?>" title="<?php esc_attr_e('List','besa'); ?>" ><i class="<?php echo besa_get_icon('icon_shop_list') ?>"></i></a>
	        </div>
		...
		public function product_type_fillter(){
	        ...
	        $name = 'product_type';
	        besa_woocommerce_product_fillter($options, $name, apply_filters('besa_product_type_fillter_default', $default) );
	    }
		...
		public function product_type_query( $q ) {
	        $name = 'product_type'; 
	        $default = apply_filters('besa_product_type_fillter_default', 'recent_product');
		...
		public function display_modes_active() {
			if( class_exists('WooCommerce_simple_auction') ) return false;

	 		$active = besa_tbay_get_config('enable_display_mode', false);
