    ...
    protected function register_section_style_search_form() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    {{WRAPPER}} .tbay-search-form .select-category,{{WRAPPER}} .tbay-search-form .button-search:not(.icon),{{WRAPPER}} .tbay-search-form .select-category > select' => 'height: {{SIZE}}{{UNIT}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .tbay-search-form .select-category .optWrapper' => 'left: -{{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .autocomplete-suggestions' => 'width: calc( 100% - -{{LEFT}}{{UNIT}} - -{{RIGHT}}{{UNIT}} - 2px ) !important; left: -{{LEFT}}{{UNIT}};',
                ],
                'condition' => [ 
                    'border_style_tbay_search_form!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '.rtl {{WRAPPER}} .tbay-search-form .select-category .CaptionCont, .rtl {{WRAPPER}} .tbay-search-form .select-category.input-group-addon '=> 'border-radius: 0 {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} 0;',
                ],
            ]
        ); 
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tbay-search-form .select-category .CaptionCont,{{WRAPPER}} .tbay-search-form .select-category'    => 'background: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Border Radius Btn Search', 'besa'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
                'selectors'  => [
                    '{{WRAPPER}} .button-group, {{WRAPPER}} .button-search' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
            ]
        ); 
...
$widgets_manager->register(new Besa_Elementor_Search_Form());
