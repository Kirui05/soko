...
class Besa_Elementor_Nav_Menu extends Besa_Elementor_Widget_Base {
    ...
    private function register_section_style_main_menu() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li> a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li> a'=> 'color: {{VALUE}} !important',
                    '{{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li > a i'=> 'color: {{VALUE}} !important',
                    '{{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li> > a .caret:before'  => 'color: {{VALUE}} ',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li> a:hover,
                    {{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li > a:focus,
                    {{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li.active > a'    => 'background-color: {{VALUE}} !important',
                ],
            ]
        );        
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li> a:hover,  
                    {{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li > a:focus, 
                    {{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li.active > a,
                    {{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li > a:hover .caret,
                    {{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li > a:focus .caret,  
                    {{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li.active > a .caret'    => 'color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .tbay-nav-menu-{{ID}} >ul > li> a:hover',
                'condition' => [
                    'layout' => 'horizontal',
                ],
            ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tbay-nav-menu-{{ID}} > ul > li > a' => 'padding-left: {{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}} !important',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tbay-nav-menu-{{ID}} > ul > li > a' => 'padding-top: {{SIZE}}{{UNIT}}; padding-bottom: {{SIZE}}{{UNIT}} !important',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tbay-nav-menu-{{ID}} > ul > li:not(:last-child)' => 'margin-right: {{SIZE}}{{UNIT}} !important',
                    'body.rtl {{WRAPPER}} .tbay-nav-menu-{{ID}} > ul > li:not(:last-child)' => 'margin-left: {{SIZE}}{{UNIT}} !important',
                ],
            ]
        );
    ...
    private function register_section_style_menu_dropdown() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .active-mega-menu .elementor-widget-wp-widget-nav_menu > .elementor-widget-container > h5' => 'font-size: {{SIZE}}{{UNIT}} !important',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [ 
                    ...
                    {{WRAPPER}} .dropdown-menu .elementor-nav-menu > li > a:hover,
                    {{WRAPPER}} .active-mega-menu .menu > li> a:hover,
                    {{WRAPPER}} .active-mega-menu .elementor-nav-menu > li > a:hover' => 'color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .dropdown-menu > li, {{WRAPPER}} .active-mega-menu .menu > li'       => 'padding-left: {{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}} !important',
                ],
                'separator' => 'before',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dropdown-menu > li, {{WRAPPER}} .active-mega-menu .menu > li'       => 'padding-top: {{SIZE}}{{UNIT}}; padding-bottom: {{SIZE}}{{UNIT}} !important',
                ],
            ]
        );
        ...
        $this->add_responsive_control( 
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .dropdown-menu, {{WRAPPER}} .active-mega-menu .menu'       => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
            ]
        );
    ...
    private function register_section_toggle_menu() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .toggle-menu-title' => 'text-align: {{VALUE}} !important;',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
				...
				'selectors' => [
					'{{WRAPPER}} .toggle-menu-title span' => 'font-size: {{SIZE}}{{UNIT}} !important;',
				],
            ]
        );
        $this->add_responsive_control(
            ...
            [
				...
				'selectors' => [
					'{{WRAPPER}} .toggle-menu-title span' => 'line-height: {{SIZE}}{{UNIT}} !important;',
				],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => '700',
				'selectors' => [
					'{{WRAPPER}} .toggle-menu-title span' => 'font-weight: {{VALUE}} !important',
				],
            ]
        );
        ...
        $this->add_control(
            'ajax_toggle',
            [
                'label' => esc_html__( 'Ajax Toggle Menu', 'besa' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'description' => esc_html__( 'Show/hidden Ajax Toggle Menu', 'besa' ), 
                'condition' => [
        ...
        $this->add_control(
            ...
            [
				...
				'selectors' => [
                    ...
                    {{WRAPPER}} .toggle-menu-title svg' => 'font-size: {{SIZE}}{{UNIT}} !important;',
                ],
                'condition' => [
                    'show_toggle_menu_icon!' => '',
                ],
    ...
    private function register_section_canvas_menu() {
        ...
        $this->add_control(
            ...
            [
				...
				'selectors' => [
                    ...
                    {{WRAPPER}} .btn-canvas-menu svg' => 'font-size: {{SIZE}}{{UNIT}} !important;',
                ],
            ]
        );
        ...
        $this->add_control(
            'ajax_canvas',
            [
                'label' => esc_html__( 'Ajax canvas Menu', 'besa' ),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__( 'Show/hidden Ajax canvas Menu', 'besa' ), 
                'default' => 'no',
                'condition' => [ 
                    'show_canvas_menu' => 'yes',
                    'layout!' => 'horizontal',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .toggle-canvas-title' => 'font-size: {{SIZE}}{{UNIT}} !important;',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .toggle-canvas-title' => 'line-height: {{SIZE}}{{UNIT}} !important;',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => '', 
                'selectors' => [
                    '{{WRAPPER}} .toggle-canvas-title' => 'text-align: {{VALUE}} !important;',
                ],
            ]
        );
    ...
    private function register_section_style_toggle_menu() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .toggle-menu-title'    => 'background-color: {{VALUE}} !important',
                ],
            ]
        );     
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .toggle-menu-title, {{WRAPPER}} .toggle-menu-title > *'=> 'color: {{VALUE}} !important',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    {{WRAPPER}} .open .toggle-menu-title a'=> 'color: {{VALUE}} !important',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .toggle-menu-title' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
				],
			]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .toggle-menu-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
				],
			]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .toggle-menu-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
				],
			]
        );
...
$widgets_manager->register(new Besa_Elementor_Nav_Menu());