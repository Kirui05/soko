...
class Besa_Elementor_Testimonials extends  Besa_Elementor_Carousel_Base{
    ...
    private function render_item_excerpt( $item ) {
        ...
        $testimonial_heading  = $item['testimonial_heading'];
        if(isset($testimonial_heading) && !empty($testimonial_heading)) {
            ?>
                <span class="testimonial-heading"><?php echo trim($testimonial_heading) ?></span>
            <?php
        }
...
$widgets_manager->register(new Besa_Elementor_Testimonials());
