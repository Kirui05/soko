...
class Besa_Elementor_Product_CountDown extends Besa_Elementor_Carousel_Base {
    ...
    public function render_content_product_count_down() {
        ...
        wc_get_template( 'layout-products/layout-products.php' , array( 'loop' => $loop, 'product_style' => $product_style, 'countdown' => true, 'attr_row' => $attr_row) );
        
    }
    

}
$widgets_manager->register(new Besa_Elementor_Product_CountDown());