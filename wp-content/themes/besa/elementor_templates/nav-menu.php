...
if( $show_content_menu === 'yes' && besa_tbay_is_home_page() && !is_home() ) {
...
<div <?php echo $this->get_render_attribute_string('wrapper'); ?>>
	...
	<?php if ( $show_toggle_menu || $show_canvas_menu ) echo '<div '. $this->get_render_attribute_string('content-class') .' >'; ?>
