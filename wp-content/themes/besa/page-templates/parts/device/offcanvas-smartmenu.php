            ...
            <div class="mmenu-account">
                <?php 
                    ...
                    if( !empty($menu_third_id) ) {
                        ...
                        $menu_third_name = besa_get_transliterate($menu_third_obj->slug);
                    }
    ...
    <div class="tbay-offcanvas-body">
        ...
        <nav id="tbay-mobile-menu-navbar" class="menu navbar navbar-offcanvas navbar-static">
            <?php
                ...
                if ( !empty($menu_obj) ) {
                    $menu_name = besa_get_transliterate($menu_obj->slug);
                }
                ...
                if( isset($menu_second) && $menu_second ) {
                    ...
                    if( !empty($menu_second_id) ) {
                        ...
                        $menu_second_name = besa_get_transliterate($menu_second_obj->slug);
                    }
