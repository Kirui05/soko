...
<?php if( !besa_catalog_mode_active() ) : ?>
	...
	<div class="tbay-login">
		...
		<?php } elseif( !besa_catalog_mode_active() && defined('BESA_WOOCOMMERCE_ACTIVED') && BESA_WOOCOMMERCE_ACTIVED && !empty(get_option('woocommerce_myaccount_page_id')) ) { ?>  
