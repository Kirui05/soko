							...
							<li id="mcitem-<?php echo esc_attr($_id);?>-<?php echo esc_attr($cart_item_key); ?>">
								...
								<div class="product-details">
									...
									<div class="group">
										...
										<?php 
                                            if (besa_tbay_get_config('show_mini_cart_qty', false)) {
									...
									<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
									    '<a href="%s" class="remove remove_from_cart_button" aria-label="%s" data-product_id="%s" data-product_sku="%s" data-cart_item_key="%s"><i class="'.besa_get_icon('icon_remove').'"></i></a>',
